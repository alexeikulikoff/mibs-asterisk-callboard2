...
public class AgentStatus {
	...
	public AgentStatus() {
		...
		colors.put(2, new Color(255, 51, 0));  // AST_DEVICE_INUSE
		...
		colors.put(6, new Color(230, 230, 0));   //  AST_DEVICE_RINGING
		colors.put(7, new Color(230, 230, 0));   //  AST_DEVICE_RINGINUSE
